...
export default function MeshDriftShader() {
  ...
  useEffect(() => {
    ...
    // Colors: #10002B, #7F00FF, #33AEB9, #0920F4
    ...
    const render = () => {
      ...
      const seconds = elapsed * 0.73;

      // Set Uniforms as specified in 21st.dev fragment shader header
      gl.uniform3fv(uColorsLoc, colorValues);
      gl.uniform4f(uSceneLoc, canvas.width, canvas.height, seconds, 4.0);
      gl.uniform4f(uShapeLoc, 1.10, 0.34, 0.50, 0.00);
      gl.uniform4f(uSurfaceLoc, 2.40, 0.96, -0.10, 0.96);
      gl.uniform4f(uFinishLoc, 0.00, 0.36, 0.026, 0.07);
